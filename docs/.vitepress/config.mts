    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '转移现象', items: [
              { text: '第三人格和第三地点', link: '/posts/转移现象/第三人格和第三地点' },
              { text: '犬伏景子和凉荫穗鸟', link: '/posts/转移现象/犬伏景子和凉荫穗鸟' },
              { text: '阿尔法和欧米茄', link: '/posts/转移现象/阿尔法和欧米茄' },
              { text: '7日之中交错的轨迹', link: '/posts/转移现象/7日之中交错的轨迹' },
            ] },
          { text: '隐藏故事', items: [
              { text: '悟，榎本，以及“我”', link: '/posts/隐藏故事/悟，榎本，以及“我”' },
              { text: 'Self在哪里', link: '/posts/隐藏故事/Self在哪里' },
              { text: '优希堂沙也香', link: '/posts/隐藏故事/优希堂沙也香' },
              { text: '优希堂计划', link: '/posts/隐藏故事/优希堂计划' },
            ] },
          { text: '未完篇章', items: [
              { text: 'Self的心理学隐喻', link: '/posts/未完篇章/Self的心理学隐喻' },
