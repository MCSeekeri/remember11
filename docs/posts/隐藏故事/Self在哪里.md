...
很明显，悟很讨厌`Self`，因为他认为它杀死了他的妹妹沙也香。他花了 5 年的时间来引诱 `Self` 并试图囚禁它。

## 那家伙

[Tips088-那家伙](/data/剧情资料/全Tips一览.md#_88-那家伙)那家伙 记载如下：
...
那么，`Self`究竟是谁？很明显，它是一个视角与玩家一致的存在。

让我们以相反的顺序来一一解释。

## 5.不完美的记忆

正如前文所提到的，`我`只知道我们从心篇中所得到的信息。他知道悟和黛曾经的关系，这是从我们作为心的视角中所了解到的；但我们并不知道他们为什么而分手，因为这从来没有被提起过。他知道犬伏的历史，因为心曾阅读过她的档案。但`我`并不知道自己的父母，因为在心篇中，这件事从未被提起过。
...
对于`Self`来说，他先是吸取了心篇中的信息，又进而形成了`我`的人格，尽管`我`的存在事实上同心篇的存在是同步的。

## 2.存在于零维

玩家不在游戏中，而是在显示器的另一边。玩家在游戏中是无处不在的，又是完全不存在的。对于游戏中的角色来说，Self 也是如此。
...
通过代表角色做出选择，`Self`可以直接干预他们的行为。你引导心穿过雪地并决定她的命运。你防止悟被刺伤，并塑造他对其他角色的感情。

但`Self`也可以间接地影响其他角色：

在第一天结束的时候，玩家可以选择吃炖肉、粥或中式盖饭。不管玩家做出的选项是什么，避难小屋中的每个人都会选择与你相同的选项。

如果你让黄泉木看守口粮，心会不假思索地把罐子给黄泉木。但是，如果你让心保管口粮，她仍然会试图把口粮给黄泉木，但他这次则拒绝了她的提议。我们的选择并没有影响心，而是影响了黄泉木。

`Self`的想法和决定不只是影响了心和悟。它们不知不觉地扩散出去，影响着整个世界。

## 【我】

除了`我`，在日语原文中，还有另一个实体会使用奇怪的[代词](悟，榎本，以及“我”#代词)`【我】`（ワタシ）。在游戏中，它唯一的一次出现是在心篇早期的一个章节中：
...
`【我】`跟随心，观察、收集信息，偶尔做出影响心的选择。从`【我】`那里得到的信息将会被输入`我`。

## 咖啡

榎本用咖啡解释了时空传送装置的功能。他把悟比作黑咖啡，说他是纯洁的，而心的意识就像加了牛奶的咖啡，是肮脏的。这个金发男人的身体只被`我`所占据，但心的身体则是`【我】`和心意志的混合体。
...
`Self`/`那家伙`是一个与玩家观点一致的实体。它至少有两种已知的表现形式。第一个是【我】，一个观察心并偶尔影响她的人。这些信息随后被用来创造`我`，他接管了黄头发的身体，并相信自己就是悟。但是，优希堂为何讨厌`Self`呢？我们将在下一篇文章中探究其原因。
